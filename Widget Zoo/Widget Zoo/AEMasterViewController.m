...
@interface AEMasterViewController () {
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (AEDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
